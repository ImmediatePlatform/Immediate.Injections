...
public static class AnalyzerTestHelpers
{
	...
	{
		var csTest = new ImmediateInjectionsGeneratorAnalyzerTest<TAnalyzer>
		{
	...
	private sealed class ImmediateInjectionsGeneratorAnalyzerTest<TAnalyzer> : CSharpAnalyzerTest<TAnalyzer, DefaultVerifier>
		where TAnalyzer : DiagnosticAnalyzer, new()
	{
		protected override IEnumerable<Type> GetSourceGenerators() =>
			[typeof(ImmediateInjectionsGenerator)];
	}
